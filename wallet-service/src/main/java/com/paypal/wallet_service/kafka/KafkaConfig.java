...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, PaymentResponseDto> walletConsumerFactory() {

        JsonDeserializer<PaymentResponseDto> deserializer =
                new JsonDeserializer<>(PaymentResponseDto.class);

        deserializer.addTrustedPackages("*");

        return new DefaultKafkaConsumerFactory<>(
                commonProps("wallet-hold-group"),
                new StringDeserializer(),
                deserializer
        );
    }
    ...
    walletKafkaListenerContainerFactory() {
        ...
        ConcurrentKafkaListenerContainerFactory<String, PaymentResponseDto> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
